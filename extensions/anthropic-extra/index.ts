...
export default function (pi: ExtensionAPI) {
	pi.registerProvider("anthropic-extra", {
		...
		models: [
			{
				id: "claude-opus-5-5",
				name: "Claude Opus 5.5 (Extra)",
				reasoning: true,
				compat: { forceAdaptiveThinking: true, supportsMidConvoEffort: true, supportsTemperature: false, supportsStrictTools: true },
			...
			},
			{
				...
				reasoning: true,
				compat: { forceAdaptiveThinking: true, supportsMidConvoEffort: true, supportsStrictTools: true },
